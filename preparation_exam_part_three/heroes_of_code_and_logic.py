...
def playing_game(heroes_dict):
    while True:
        ...
        if current_command == "CastSpell":
            ...
            available_mana_points = heroes_dict[hero_name][1]

            if available_mana_points >= mana_points_needed:
            ...
            attacker = command[3]
            available_hit_points = heroes_dict[hero_name][0]

            hit_points = available_hit_points - damage
            if hit_points > 0:
            ...
            available_hp = int(heroes_dict[hero_name][0])
